...
## REQ-DEMO-0001 — Payment intent intake must accept an idempotent request
...
## REQ-DEMO-0002 — Every response must carry a correlation identifier
...
- Verification: `.qgate/trace-matrix.json` coverage for `REQ-DEMO-0002`.

## REQ-DEMO-0003 — Amounts must be minor units with an explicit currency
...
## REQ-DEMO-0004 — The build must be reproducible without network access
...
## REQ-DEMO-0005 — Recorded findings must respect severity and confidence gating
...
## REQ-DEMO-0006 — Requirements must be traced to tests and evidence
