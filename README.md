...
# fingerprint = e34e4294f184272478a1dd4fb8a44d6183627aecd81034b3b993cb10ff838fd1
# files       = 161
# newest      = packages/qgate/test/run-all.mjs  (2026-09-19T18:52:31.169Z)
```
...
# exit 0  ⇒  BASELINE-FRESHNESS current=e34e4294f184 files=6 fresh=1 superseded=5 stale=0 tampered=0 count_drift=0
```
