...
# fingerprint = c9b13281b39a0d59c41f3082d1eeea02eb8730f6633cb372a993afc4d3dc1d2b
# files       = 160
# newest      = package.json  (2026-09-19T18:40:01.177Z)
```
...
# exit 0  ⇒  BASELINE-FRESHNESS current=c9b13281b39a files=6 fresh=1 superseded=5 stale=0 tampered=0 count_drift=0
```
